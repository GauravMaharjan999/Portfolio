...
const $window = jQuery(window), /* window cash */
	...
	$body = jQuery("body"), /* body cash */
	$header = jQuery('.large-header'), /* header cash */
	$nav = jQuery('#nav'), /* nav cash */
...
var Gaurav = {
	...
	functionality: {
		...
		goToTop: function () {
			jQuery(".Gaurav_totop").on('click', function (e) {
				e.preventDefault();
